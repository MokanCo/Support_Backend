...
router.post('/bulk-delete', roleMiddleware(['admin']), makeBulkDeleteAssetsHandler('marketing_assets'));
router.post('/download-zip', roleMiddleware(['admin', 'partner']), makeBulkDownloadAssetsHandler('marketing_assets'));
