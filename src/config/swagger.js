...
const swaggerDefinition = {
  ...
  tags: [
    ...
    { name: 'AR Dashboard', description: 'Accounts Receivable KPIs and charts' },
    { name: 'AR Settings', description: 'Global AR configuration' },
    { name: 'AR Products', description: 'Billable products and services' },
    { name: 'AR Billing Profiles', description: 'Partner billing profiles' },
    { name: 'AR Invoices', description: 'Invoice lifecycle' },
    { name: 'AR Payments', description: 'Manual payment recording' },
    { name: 'AR Credits', description: 'Credits and write-offs' },
    { name: 'AR Recurring', description: 'Recurring billing templates' },
    { name: 'AR Statements', description: 'Partner statements' },
    { name: 'AR Reports', description: 'AR reports and exports' },
    { name: 'AR Imports', description: 'CSV import wizard' },
    { name: 'AR Audit', description: 'AR audit logs and job runs' },
